...
def title_bar(text, width, height=32, font_scale=0.7):
    """
...
def add_title(img, text, font_scale=0.7):
...
def make_eight_panel(
    ...
    if metrics_text is not None:
        header = title_bar(metrics_text, composite.shape[1], height=40, font_scale=0.8)
