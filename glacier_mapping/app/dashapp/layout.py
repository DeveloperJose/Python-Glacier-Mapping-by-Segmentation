...
def get_sidebar():
    sidebar = html.Ul(
        [
            html.A(
                [html.Div(["Glacier Mapping"], className="sidebar-brand-text mx-3")],
                href="#",
...
def get_page_content(obj):
    page_content = html.Div(
        [
            ...
            html.Div(
                [get_dataTable(obj.get_df()), get_scatter()], className="row mb-4"
            ),
            html.Div(
                [
...
def get_layout(obj):
    layout = html.Div(
        [
            get_sidebar(),
            html.Div(
                [html.Div([get_topbar(obj), get_page_content(obj)], id="content")],
