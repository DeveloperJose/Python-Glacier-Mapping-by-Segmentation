...
class ErrorHandler:
    ...
    def __init__(self, output_dir: str, run_name: str, mlflow_logger=None):
        ...
        self.error_log_dir = self.run_dir / "error_logs"
    ...
    def create_error_summary(self) -> Dict[str, Any]:
        ...
        for error_file in sorted(error_files)[-5:]:  # Last 5 errors
            try:
                ...
                summary["error_types"][exc_type] = (
                    summary["error_types"].get(exc_type, 0) + 1
                )
                    ...
                    summary["recent_errors"].append(
                        {
                            ...
                            "type": exc_type,
                            "message": error_data.get("exception_message", "")[:100]
                            + "..."
                            if len(error_data.get("exception_message", "")) > 100
                            else error_data.get("exception_message", ""),
                        }
                    )
            except Exception:
                pass
                ...
                summary["recent_warnings"].append(
                    {
                        ...
                        "message": warning_data.get("message", "")[:100] + "..."
                        if len(warning_data.get("message", "")) > 100
                        else warning_data.get("message", ""),
                    }
                )
            except Exception:
                pass
...
def setup_error_handler(
    output_dir: str, run_name: str, mlflow_logger=None
) -> ErrorHandler:
    """
