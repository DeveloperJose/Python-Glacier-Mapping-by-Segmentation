# https://github.com/nasa-jpl/its_live/blob/558db0b77f3bb845eb262ebbb2869006d1ec5c76/notebooks/datacube_tools.py#L305
...
class DATACUBETOOLS:
    ...
    def get_subcube_for_bounding_box(self, bbox, bbox_epsg_str, variables=["v"]):
        ...
        print(cube_feature["properties"]["epsg"], bbox_epsg_str)
        if cube_feature["properties"]["epsg"] != bbox_epsg_str:
            print(
                f"bbox is in epsg:{bbox_epsg_str}, should be in datacube {cube_feature['properties']['epsg']}"
            )
            return None
